...
import './style.css';
var unlimitedAccess = document.querySelector('h1');
var checkboxWrapper = document.querySelector('.checkbox-wrapper');
var cross = document.querySelector('.cross');
var bestOffer = document.querySelector('.best-offer');
var yearOfferTitle = document.querySelector('.yearly .offer-title');
var year = document.querySelector('.yearly');
var weekOfferTitle = document.querySelector('.week .offer-title');
var week = document.querySelector('.week');
var offerSubtitle = document.querySelector('.offer-subtitle');
var pricesPerWeek = document.querySelectorAll('.price-per-week');
var continueButton = document.querySelector('.continue');
var selectBoxOption = document.querySelectorAll('.select-box__option');
...
var ultimatedArt = document.querySelector('.cards__card_unlimited-art p');
var exclusiveStyles = document.querySelector('.cards__card_exclusive-styles p');
var magicAvatars = document.querySelector('.cards__card_magic-avatars  p');
var selectBox = document.querySelector('.select-box');
var box = document.querySelector('.select-box__current');
var values = document.querySelectorAll('.select-box__value');
var listOfLanguages = {
  'de': 'de',
  'en': 'en',
  'es': 'es',
...
var prices = ['$39.99', '$0.48', '$6.99'];
var pricePerYear = prices[0],
  priceOfYearlyAccess = prices[1],
  priceOfWeeklyAccess = prices[2];
var footer = document.querySelector('footer');
console.log(navigator);
var firstClick = true;
changeLanguage();
box.addEventListener('click', function (e) {
  var value = e.target.closest('.select-box__value');
  if (!value) return;
...
function _changeLanguage() {
  _changeLanguage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var changeLang,
      currentLang,
      data,
      changeStyles,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          changeStyles = function _changeStyles() {
          ...
          changeLang = _args.length > 0 && _args[0] !== undefined ? _args[0] : '';
          currentLang = changeLang.toLowerCase() || listOfLanguages[navigator.language] || 'en';
          if (location.search) {
            currentLang = location.search.split('=')[1];
          }
          _context.next = 6;
          return import("./languages/".concat(currentLang, ".json"));
        case 6:
          data = _context.sent;
...
selectBoxOption.forEach(function (el) {
...
checkboxWrapper.addEventListener('click', function (e) {
  var radioInput = e.target.closest('.modern-radio');
